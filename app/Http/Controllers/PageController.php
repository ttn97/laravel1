...
class PageController extends Controller
{
    ...
    public function tintuc($id){
        ...
        $tinlienquan = TinTuc::where('idChuyenMuc',$tintuc->idChuyenMuc)->take(5)->get();
    ...
    public function getLoaichuyenmuc($id){
        $muc=ChuyenMuc::find($id);
        $tintuc=TinTuc::where('idChuyenMuc',$muc->id)->paginate(5);
        return view('pages/loaichuyenmuc')->with('muc',$muc)->with('tintuc',$tintuc);
    }
